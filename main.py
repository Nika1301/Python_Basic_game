...
player_rect = player.get_rect(topleft = (50, 300))
...
def create_enemy():
    ...
    enemy_rect = pygame.Rect(WIDTH - enemy_size[0], random.randint(0, HEIGHT), *enemy_size)
...
while playing:
    ...
    main_display.blit(FONT.render(str(score), True, COLOR_BLACK), (WIDTH - 30, 10))
